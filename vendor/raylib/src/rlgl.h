...
// Default internal render batch elements limits
        ...
        #define RL_DEFAULT_BATCH_BUFFER_ELEMENTS  4096
        //8192
    #endif
    #if defined(GRAPHICS_API_OPENGL_ES2)
...
rlRenderBatch rlLoadRenderBatch(int numBuffers, int bufferElements)
{
    ...
    for (int i = 0; i < numBuffers; i++)
    {
        ...
        TRACELOG(RL_LOG_INFO, "OHASANOV: Gpu Texcoord Stuff Done");
        ...
        TRACELOG(RL_LOG_INFO, "OHASANOV: Gpu Color Stuff Done");
        // Fill index buffer
